...
public class PirmasSkyriusAntroLapoFragmentas extends Fragment {
	
	public static final String TAG = "PirmasSkyriusAntroLapoFragmentas";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		{	
			p_1_2.setSector("1");
			p_1_2.setIndex("1_2");
			p_1_2.setTitle(getString(R.string.t_1));
			p_1_2.setDescription(getString(R.string.p_1_2));
	...
	public PirmasSkyriusAntroLapoFragmentas(){
	}
