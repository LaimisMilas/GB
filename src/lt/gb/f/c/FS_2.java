...
public class FS_2 extends Fragment {

	protected static final String TAG = FS_2.class.getName();

	public static FS_2 newInstance() {
		FS_2 f = new FS_2();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		setImageResource(R.drawable.t_trauk_2);
