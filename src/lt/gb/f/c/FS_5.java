...
public class FS_5 extends Fragment {

	protected static final String TAG = FS_5.class.getName();

	public static FS_5 newInstance() {
		FS_5 f = new FS_5();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		setImageResource(R.drawable.t_trauk_5);
