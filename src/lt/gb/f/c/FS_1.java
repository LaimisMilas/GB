...
public class FS_1 extends Fragment {

	protected static final String TAG = FS_1.class.getName();
	
	public static FS_1 newInstance() {
		FS_1 f = new FS_1();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		setImageResource(R.drawable.t_trauk_1);
