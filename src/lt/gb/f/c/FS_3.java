...
public class FS_3 extends Fragment {

	protected static final String TAG = FS_3.class.getName();
	
	public static FS_3 newInstance() {
		FS_3 f = new FS_3();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		setImageResource(R.drawable.t_trauk_3);
